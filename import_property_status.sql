-- Generated automatically from property_status.csv
...
INSERT INTO public.propiedades (
  ...
  2800.0, TRUE, '2023-02-01', '2023-01-20', NULL, FALSE
)
...
INSERT INTO public.propiedades (
  ...
  3600.0, FALSE, '2023-04-05', '2023-03-15', '2024-01-20', TRUE
)
ON CONFLICT (id) DO UPDATE SET
  nombre = 'Aigües del Ll 118',
  estado = 'vendido',
...
INSERT INTO public.propiedades (
  ...
  2240.0, TRUE, '2023-06-01', '2023-05-20', NULL, FALSE
)
ON CONFLICT (id) DO UPDATE SET
  nombre = 'Aigües del Llob. 91',
  estado = 'comprado',
...
INSERT INTO public.propiedades (
  ...
  4000.0, FALSE, '2023-08-01', '2023-07-15', NULL, FALSE
)
ON CONFLICT (id) DO UPDATE SET
  nombre = 'Aigües del Llobregat',
  estado = 'reformando',
...
INSERT INTO public.propiedades (
  ...
  2560.0, TRUE, '2023-10-01', '2023-09-25', NULL, TRUE
)
ON CONFLICT (id) DO UPDATE SET
  nombre = 'Aigües del Llobregat 131',
  estado = 'comprado',
