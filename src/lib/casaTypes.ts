// src/lib/casaTypes.ts
// Types and helpers for Casa section (Gastos, Ingresos, Activos)
...
export interface CasaCategoria {
  id: string;
  nombre: string;
  slug: string;
}

export interface CasaGasto {
  id: string;
  concepto: string;
...
export interface CasaAreaCategoria {
  id: string;
  area_id: string;
